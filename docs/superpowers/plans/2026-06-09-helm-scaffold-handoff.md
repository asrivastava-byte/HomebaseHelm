# Helm Scaffold & Handoff Toolkit

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Ship `scripts/scaffold-workflow.rb`, ERB templates, HB1 `.template` files, `docs/handoff/TEMPLATE.md`, and `docs/handoff/user_lookup.md` — everything a pack team needs to stand up a new BFF workflow from scratch.
